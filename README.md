...
| --------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Fashion Store Assistant (LLM, RAG, Google Sheets) | Business email classification and response automation using LLMs, RAG, and Google Sheets integration | [Solve Business Problems with AI.ipynb](Fashion-Store%20Assistant/Solve%20Business%20Problems%20with%20AI.ipynb)                                    |
...
3. **Create a new Heroku app**:
   ...
   ```
4. **Push to Heroku**:Ensure your `Procfile` is correctly set up for Flask:
