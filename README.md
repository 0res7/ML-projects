...
| --------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Fashion Store Assistant (LLM, RAG, Google Sheets) | Business email classification and response automation using LLMs, RAG, and Google Sheets integration | [Solve Business Problems with AI.ipynb](AI-assessment/Solve%20Business%20Problems%20with%20AI.ipynb)                                    |
